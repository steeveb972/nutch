...
import de.l3s.boilerpipe.filters.french.*;
 ...
 */
public final class EventExtractor extends ExtractorBase {
    ...
    public boolean process(TextDocument doc)
        ...
        return
                ...
                TerminatingBlocksFinder.INSTANCE.process(doc)
                        ...
                        | IgnoreBlocksBeforeTitleFilter.DEFAULT_INSTANCE.process(doc)
